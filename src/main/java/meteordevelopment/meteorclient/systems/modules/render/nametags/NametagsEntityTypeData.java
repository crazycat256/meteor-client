...
public class NametagsEntityTypeData implements ICopyable<NametagsEntityTypeData>, ISerializable<NametagsEntityTypeData>, IChangeable, IEntityTypeData<NametagsEntityTypeData>, IScreenFactory {
    ...
    public NametagsEntityTypeData(double scale, boolean onlyVisible, boolean culling, double maxCullRange, double maxCullCount) {
        this.scale = scale;
    ...
    public NametagsEntityTypeData copy() {
        return new NametagsEntityTypeData(scale, onlyVisible, culling, maxCullRange, maxCullCount);
    }
    ...
    public NbtCompound toTag() {
        ...
        tag.putBoolean("onlyVisible", onlyVisible);
    ...
    public NametagsEntityTypeData fromTag(NbtCompound tag) {
        ...
        onlyVisible = tag.getBoolean("onlyVisible");
